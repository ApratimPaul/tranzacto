<?php
    ...
    if(isset($_GET['employee'])){
        $data = $database->getReference('users/'.$uid.'/employees/'.$_GET["employee"].'/tips/')->getSnapshot()->getValue();
            ...
            <div id="content" style="background: #c8d8e4;height: 40vh;">
                <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top" style="/*background-color: #2b6777!important;*/">
                    <div class="container-fluid">
                        <p style="padding: 0;margin: 0;font-size: 32px;font-weight: 700;">Tips</p>
                ...
                <div class="container-fluid" style="padding: 50px;">
                    <div class="card shadow">
                        <div class="card-header py-3" style="display: flex;justify-content: space-between;">
                            <p class="text-primary m-0 fw-bold">Tips History</p>
                        </div>
                        <div class="card-body">
